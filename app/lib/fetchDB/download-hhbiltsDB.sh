...
VOID=$1
REMOTE_FILE_NAME="UniRef30_2023_02_hhsuite.tar.gz"
VERSION=$(echo "$input" | cut -d'_' -f2-3)
DB_NAME="UniRef30"
TARGET_DIR=$2

ROOT_URL="https://wwwuser.gwdguser.de/~compbiol/uniclust/${VERSION}/${REMOTE_FILE_NAME}"
